"""Stage 11 -- ESPN CFB per-play participants (CFB extra).

Thin shim over ``scrape_cfb_participants``: the directory listing IS the pipeline, and the stage
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_11_play_participants_scrape.py -s 2026 -e 2026
"""
