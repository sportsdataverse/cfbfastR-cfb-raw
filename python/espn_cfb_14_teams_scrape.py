"""Stage 14 -- ESPN CFB per-season team + conference reference (CFB extra).

Thin shim over ``scrape_cfb_teams``: the directory listing IS the pipeline, and the stage
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_14_teams_scrape.py -s 2026 -e 2026
"""
