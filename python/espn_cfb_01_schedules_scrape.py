"""Stage 01 -- ESPN CFB season schedules + the schedule master.

Thin shim over ``scrape_cfb_schedules``: the directory listing IS the pipeline, and the stage
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_01_schedules_scrape.py -s 2026 -e 2026
"""

from __future__ import annotations

from scrape_cfb_schedules import main
