"""Stage 13 -- ESPN CFB ESPN Total QBR (CFB extra).

Thin shim over ``scrape_cfb_qbr``: the directory listing IS the pipeline, and the stage
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_13_qbr_scrape.py -s 2026 -e 2026
"""

from __future__ import annotations

from scrape_cfb_qbr import main
