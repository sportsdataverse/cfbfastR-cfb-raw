"""Stage 12 -- ESPN CFB ESPN power index (CFB extra).

Thin shim over ``scrape_cfb_power_index``: the directory listing IS the pipeline, and the stage
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_12_power_index_scrape.py -s 2026 -e 2026
"""

from __future__ import annotations

from scrape_cfb_power_index import main
