"""Stage 50 -- ESPN CFB recruiting classes (CFB extra).

Thin shim over ``scrape_cfb_recruits``: the directory listing IS the pipeline.
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_50_recruits_scrape.py -s 2026 -e 2026
"""

from __future__ import annotations

from cfb_raw_scrape.scrape_cfb_recruits import main
