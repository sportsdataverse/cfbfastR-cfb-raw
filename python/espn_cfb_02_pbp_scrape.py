"""Stage 02 -- ESPN CFB per-game summary -> raw/ and enriched final/.

Thin shim over ``scrape_cfb_json``: the directory listing IS the pipeline, and the stage
...
Example:
    One season::
        ...
        "$PY" python/espn_cfb_02_pbp_scrape.py -s 2026 -e 2026
"""
